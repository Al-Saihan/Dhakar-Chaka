...
<body>
    ...
    <main>
        <div class="min-h-[calc(100vh-theme(spacing.16)-theme(spacing.16))] flex items-center justify-center bg-gray-100">

            <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
                <h2 class="text-2xl font-bold mb-6 text-center text-gray-800">Login to Your Account</h2>
                <form action="#" method="POST" class="space-y-6">
                    <div>
                        <label for="email" class="block text-gray-700 font-semibold mb-2">Phone Number</label>
                    ...
                    <div>
                        <a href="<?= $base ?>/signup" class="text-blue-600 hover:underline text-sm">Don't have an account?</a>
                    </div>
                    <button type="submit"
